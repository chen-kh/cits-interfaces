...
static asn_INTEGER_enum_map_t asn_MAP_TractionControlStatus_value2enum_1[] = {
	{ 0,	11,	"unavailable" },
	{ 1,	3,	"off" },
	{ 2,	2,	"on" },
	{ 3,	7,	"engaged" }
};
static unsigned int asn_MAP_TractionControlStatus_enum2value_1[] = {
	3,	/* engaged(3) */
	1,	/* off(1) */
	2,	/* on(2) */
	0	/* unavailable(0) */
};
static asn_INTEGER_specifics_t asn_SPC_TractionControlStatus_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_TractionControlStatus_tags_1[] = {
